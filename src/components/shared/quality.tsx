    ...
    >
      <Box w={["100%", "50%"]} textAlign={["center", "start"]} >
        ...
        <Text fontSize={{ base: "sm", md: "md" }} mb={['20px',"40px"]}>
          Unser Produkt entfernt effektiv organische Flecken wie Fett, Lebensmittelreste, Gras, Beeren
          und unangenehme Gerüche auf weißen и bunten Stoffах, Geschirr sowie Polstermöbeln.
        </Text>
        <ButtonComp />
      </Box>
